...
idStringToken  :  ALPHA | NUM | MINUS | COMMA | COLON | AMP | BRKT | MULT | UNICODE_TEXT | UNDERSCORE | DOT | PUNCTUATION | PLUS | EQUALS;
styleComponent: ALPHA | NUM | COLON | SPACE | BRKT | MINUS | PUNCTUATION | DOT | UNDERSCORE | UNICODE_TEXT | PLUS | EQUALS | MULT | AMP;
