...
statement
  ...
  | X_AXIS parseXAxis
  | Y_AXIS parseYAxis
  | LINE plotData                                               { yy.addLinePlot(null, $plotData); }
  | LINE text plotData                                          { yy.addLinePlot($text.text, $plotData); }
  | BAR plotData                                                { yy.addBarPlot(null, $plotData); }
  | BAR text plotData                                           { yy.addBarPlot($text.text, $plotData); }
...
dataPoint
  : NUMBER_WITH_DECIMAL STR                   { $$ = Number($1); }
